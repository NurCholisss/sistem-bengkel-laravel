...
<div class="card">
    <div class="card-header bg-light">
        <h5 class="card-title mb-0">Form Tambah Aturan</h5>
    </div>
    <div class="card-body">
        <form action="{{ route('admin.aturan.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="kata_kunci" name="kata_kunci" value="{{ old('kata_kunci') }}" required>
                <div class="form-text">Pisahkan kata kunci dengan koma (contoh: oli,mesin,berisik)</div>
            </div>

            <div class="mb-3">
                <label for="rekomendasi" class="form-label">Rekomendasi</label>
                <textarea class="form-control" id="rekomendasi" name="rekomendasi" rows="4" required>{{ old('rekomendasi') }}</textarea>
            </div>
